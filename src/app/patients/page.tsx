          ...
          <VStack spacing={8} align="stretch">
            ...
            <HStack justify="space-between">
              <Box>
                ...
                <Text color="gray.600">Manage patient records and information</Text>
              </Box>
              <Button
                leftIcon={<FiPlus />}
                colorScheme="dental"
                  ...
                  <Tbody>
                    {filteredPatients.map((patient) => (
                      <Tr key={patient.id}>
                        <Td>
                          <HStack spacing={3}>
                            <Avatar size="sm" src={patient.avatar} name={patient.name} />
                            <Box>
                        ...
                        <Td>
                          <Text fontSize="sm">{new Date(patient.lastVisit).toLocaleDateString()}</Text>
                        </Td>
                        <Td>
                          <Text fontSize="sm">
...
function ViewPatientModal({ isOpen, onClose, patient }: {
  isOpen: boolean;
  onClose: () => void;
            ...
            <TabPanels>
                ...
                <Grid templateColumns="repeat(2, 1fr)" gap={6}>
                  <GridItem>
                    <VStack align="start" spacing={4}>
                      <HStack spacing={4}>
                        <Avatar size="lg" src={patient.avatar} name={patient.name} />
                        <Box>
                          <Heading size="md">{patient.name}</Heading>
                          <Text color="gray.600">{patient.gender}, {new Date().getFullYear() - new Date(patient.dateOfBirth).getFullYear()} years old</Text>
                          <Badge colorScheme={patient.status === 'Active' ? 'green' : 'gray'} mt={2}>
                            {patient.status}
                          </Badge>
                        </Box>
                      </HStack>
              ...
              <TabPanel>
                <VStack align="stretch" spacing={4}>
                  <Box>
                    <Text fontWeight="medium" mb={2}>Medical History</Text>
                    <Text>{patient.medicalHistory || 'No medical history recorded'}</Text>
                  </Box>
                  <Box>
                    <Text fontWeight="medium" mb={2}>Allergies</Text>
                    <Text>{patient.allergies || 'No known allergies'}</Text>
                  </Box>
                  <Box>
                    <Text fontWeight="medium" mb={2}>Emergency Contact</Text>
                    <Text>{patient.emergencyContact || 'No emergency contact recorded'}</Text>
                  </Box>
                </VStack>
              </TabPanel>
              <TabPanel>
